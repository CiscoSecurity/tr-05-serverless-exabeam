...
Each response from the Exabeam API for the supported observables generates the following CTIM entities:

- `Sightings` are taken from each hit in Exabeam response.
